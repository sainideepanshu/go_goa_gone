...
func main() {
	...
	// new keyword
	var person2 = new(Person)        // this will create a new Person object and return a pointer to it
	fmt.Println("Person 2 : ", person2) // this will print the address of the Person object
